...
export {
	type SerializedAuthStrategy as ExtendedAuthStrategy,
	type PublicAuthStrategy,
	type MinimalAuthStrategy as BasicAuthStrategy,
} from './interfaces/storage.js';
export {type SimpleMfaApi as SimpleMfaInstance} from './interfaces/wrapper.js';
